...
| `git stash branch <branch-name>` | Create and switch to a new branch from a stash, applying the stash’s changes (e.g., `git stash branch feature-x stash@{0}`). Useful for saving incomplete work to a new branch. |
